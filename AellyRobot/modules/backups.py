...
# from AellyRobot.modules.sql import warns_sql as warnssql
import AellyRobot.modules.sql.blacklist_sql as blacklistsql

# from AellyRobot.modules.sql import cust_filters_sql as filtersql
# import AellyRobot.modules.sql.welcome_sql as welcsql
import AellyRobot.modules.sql.locks_sql as locksql
import AellyRobot.modules.sql.notes_sql as sql

# from AellyRobot.modules.rules import get_rules
import AellyRobot.modules.sql.rules_sql as rulessql
from AellyRobot import JOIN_LOGGER, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from AellyRobot.__main__ import DATA_IMPORT
from AellyRobot.modules.connection import connected
from AellyRobot.modules.helper_funcs.alternate import typing_action
from AellyRobot.modules.helper_funcs.chat_status import user_admin
from AellyRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("AellyRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("AellyRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `AellyRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("AellyRobot{}.backup".format(chat_id))  # Cleaning file
